...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        int permissionCheck1 = ContextCompat.checkSelfPermission(MapsActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION);
        int permissionCheck2 = ContextCompat.checkSelfPermission(MapsActivity.this, Manifest.permission.ACCESS_FINE_LOCATION);
        ...
        if (permissionCheck1 != PermissionChecker.PERMISSION_GRANTED || permissionCheck2 != PermissionChecker.PERMISSION_GRANTED)
        {
    ...
    public void loadClick()//method for loading markers
    {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            // to handle the case where the user grants the permission. See the documentation
            // for ActivityCompat#requestPermissions for more details.
            Dialog("Η χρήση της τοποθεσίας σας δεν είναι ενεργή. Ενεργοποιήστε την χρήση τοποθεσίας σας και την άδεια χρήσης της τοποθεσίας πηγαίνοντας Διαχείρηση Εφαρμογών -> Aegean App -> Άδειες");
        ...
        builder.setMessage(msg)
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        Intent i=new Intent(MapsActivity.this,MainPage.class);
                        startActivity(i);
                        finish();
                    }
                });
