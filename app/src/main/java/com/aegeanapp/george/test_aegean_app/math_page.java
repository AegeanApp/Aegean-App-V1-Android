...
public class math_page extends AppCompatActivity {
    ...
    {
        Intent i=new Intent(Intent.ACTION_VIEW,Uri.parse("https://www.math.aegean.gr/images/articles/announcements/2017-2018/orologio%20programma_fall%20semester_math.pdf"));//here must be the link that host the pdf(pdf archive?)
